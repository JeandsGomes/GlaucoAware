...
"}")
        ...
        self.label_6.setMinimumSize(QtCore.QSize(111, 0))
        self.label_6.setMaximumSize(QtCore.QSize(109, 16777215))
        font = QtGui.QFont()
        font.setFamily("Noto Sans Georgian")
        font.setPointSize(12)
        font.setBold(True)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Visualização"))
        self.edita_pushButton_voltar.setText(_translate("MainWindow", "<< Voltar"))
        self.label_3.setText(_translate("MainWindow", "Buscar"))
        self.login_lineEdit_cpf_3.setPlaceholderText(_translate("MainWindow", "    id"))
        ...
        self.login_lineEdit_cpf_5.setPlaceholderText(_translate("MainWindow", "    ID do Paciente"))
